...
namespace Microsoft.Azure.Management.Insights.Models
{
    ...
    public partial class AlertRuleResource : Resource
    {
        ...
        public AlertRuleResource(string location, string alertRuleResourceName, bool isEnabled, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string description = default(string), RuleCondition condition = default(RuleCondition), IList<RuleAction> actions = default(IList<RuleAction>), System.DateTime? lastUpdatedTime = default(System.DateTime?))
