...
namespace Microsoft.Azure.Management.IotHub
{
    ...
    internal partial class IotHubResourceOperations : IServiceOperations<IotHubClient>, IIotHubResourceOperations
    {
        ...
        {
            // Send Request
            AzureOperationResponse<IotHubDescription> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, resourceName, iotHubDescription, customHeaders, cancellationToken).ConfigureAwait(false);
