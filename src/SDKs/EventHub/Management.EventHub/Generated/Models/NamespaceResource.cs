...
namespace Microsoft.Azure.Management.EventHub.Models
{
    ...
    public partial class NamespaceResource : TrackedResource
    {
        ...
        /// enabled.</param>
        public NamespaceResource(string id = default(string), string name = default(string), string location = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), NamespaceState? status = default(NamespaceState?), string provisioningState = default(string), System.DateTime? createdAt = default(System.DateTime?), System.DateTime? updatedAt = default(System.DateTime?), string serviceBusEndpoint = default(string), string metricId = default(string), bool? enabled = default(bool?))
