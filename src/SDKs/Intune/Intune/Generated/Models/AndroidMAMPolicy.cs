...
namespace Microsoft.Azure.Management.Intune.Models
{
    ...
    public partial class AndroidMAMPolicy : Resource
    {
        ...
        /// 'targeted'</param>
        /// <param name="screenCapture">Possible values include: 'allow',
        /// 'block'</param>
        /// <param name="fileEncryption">Possible values include: 'required',
        /// 'notRequired'</param>
        public AndroidMAMPolicy(string friendlyName, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string location = default(string), string description = default(string), string appSharingFromLevel = default(string), string appSharingToLevel = default(string), string authentication = default(string), string clipboardSharingLevel = default(string), string dataBackup = default(string), string fileSharingSaveAs = default(string), string pin = default(string), int? pinNumRetry = default(int?), string deviceCompliance = default(string), string managedBrowser = default(string), System.TimeSpan? accessRecheckOfflineTimeout = default(System.TimeSpan?), System.TimeSpan? accessRecheckOnlineTimeout = default(System.TimeSpan?), System.TimeSpan? offlineWipeTimeout = default(System.TimeSpan?), int? numOfApps = default(int?), string groupStatus = default(string), System.DateTime? lastModifiedTime = default(System.DateTime?), string screenCapture = default(string), string fileEncryption = default(string))
