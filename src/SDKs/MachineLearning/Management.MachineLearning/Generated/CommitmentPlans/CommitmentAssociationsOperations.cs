    ...
    internal partial class CommitmentAssociationsOperations : IServiceOperations<AzureMLCommitmentPlansManagementClient>, ICommitmentAssociationsOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<CommitmentAssociation>>> ListWithHttpMessagesAsync(string resourceGroupName, string commitmentPlanName, string skipToken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<CommitmentAssociation>>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        public async Task<AzureOperationResponse<CommitmentAssociation>> MoveWithHttpMessagesAsync(string resourceGroupName, string commitmentPlanName, string commitmentAssociationName, MoveCommitmentAssociationRequest movePayload, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (movePayload == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "movePayload");
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
