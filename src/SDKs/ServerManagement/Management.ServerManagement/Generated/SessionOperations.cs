...
namespace Microsoft.Azure.Management.ServerManagement
{
    ...
    internal partial class SessionOperations : IServiceOperations<ServerManagementClient>, ISessionOperations
    {
        ...
        {
            // Send Request
            AzureOperationResponse<SessionResource> _response = await BeginCreateWithHttpMessagesAsync(resourceGroupName, nodeName, session, userName, password, retentionPeriod, credentialDataFormat, encryptionCertificateThumbprint, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        public async Task<AzureOperationResponse<SessionResource>> GetWithHttpMessagesAsync(string resourceGroupName, string nodeName, string session, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<SessionResource>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse<SessionResource>> BeginCreateWithHttpMessagesAsync(string resourceGroupName, string nodeName, string session, string userName = default(string), string password = default(string), RetentionPeriod? retentionPeriod = default(RetentionPeriod?), CredentialDataFormat? credentialDataFormat = default(CredentialDataFormat?), string encryptionCertificateThumbprint = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (userName != null || password != null || retentionPeriod != null || credentialDataFormat != null || encryptionCertificateThumbprint != null)
            {
            ...
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(sessionParameters, Client.SerializationSettings);
