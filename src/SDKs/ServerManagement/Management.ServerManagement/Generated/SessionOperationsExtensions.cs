...
namespace Microsoft.Azure.Management.ServerManagement
{
    ...
    public static partial class SessionOperationsExtensions
    {
            ...
            {
                return operations.CreateAsync(resourceGroupName, nodeName, session, userName, password, retentionPeriod, credentialDataFormat, encryptionCertificateThumbprint).GetAwaiter().GetResult();
            }
            ...
            {
                operations.DeleteAsync(resourceGroupName, nodeName, session).GetAwaiter().GetResult();
            }
            ...
            {
                (await operations.DeleteWithHttpMessagesAsync(resourceGroupName, nodeName, session, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            {
                return operations.GetAsync(resourceGroupName, nodeName, session).GetAwaiter().GetResult();
            }
            ...
            {
                return operations.BeginCreateAsync(resourceGroupName, nodeName, session, userName, password, retentionPeriod, credentialDataFormat, encryptionCertificateThumbprint).GetAwaiter().GetResult();
            }
