...
namespace Microsoft.Azure.Graph.RBAC.Models
{
    ...
    public partial class UserUpdateParameters
    {
        ...
        public UserUpdateParameters(bool? accountEnabled = default(bool?), string displayName = default(string), PasswordProfile passwordProfile = default(PasswordProfile), string mailNickname = default(string), string usageLocation = default(string))
        {
